...
return array (
  ...
  'after' => 'विशेषता: तारीख के बाद की तारीख होनी चाहिए।',
  'after_or_equal' => 'गुण: तारीख के बाद या उसके बराबर की तारीख होना चाहिए।',
  'alpha' => ': विशेषता में केवल अक्षर हो सकते हैं।',
  'alpha_dash' => ': विशेषता में केवल अक्षर, संख्या, डैश और अंडरस्कोर हो सकते हैं।',
  'alpha_num' => 'The: विशेषता में केवल अक्षर और संख्याएँ हो सकती हैं।',
  'array' => 'विशेषता: एक सरणी होनी चाहिए।',
  'before' => 'विशेषता: तारीख से पहले की तारीख होनी चाहिए।',
  'before_or_equal' => ': तिथि से पहले या इसके बराबर की तिथि के लिए विशेषता होनी चाहिए।',
  'between' => 
  array (
    ...
    'string' => 'ए: विशेषता के बीच होना चाहिए: न्यूनतम और: अधिकतम वर्ण।',
  ),
  ...
  'date_equals' => 'विशेषता: दिनांक के बराबर दिनांक होना चाहिए।',
  ...
  array (
    ...
    'string' => 'विशेषता: मान वर्णों से अधिक होना चाहिए।',
  ),
  'gte' => 
  array (
  ...
  'lt' => 
  array (
    'array' => 'गुण: मान आइटम से कम होना चाहिए।',
  ...
  'lte' => 
  array (
    'array' => 'गुण: मान आइटम से अधिक नहीं होना चाहिए।',
    'file' => 'ए: विशेषता से कम या बराबर होना चाहिए: मूल्य किलोबाइट।',
    'numeric' => 'गुण: मान से कम या बराबर होना चाहिए: मान।',
    'string' => 'गुण: मान वर्ण से कम या बराबर होना चाहिए।',
  ),
  'max' => 
  array (
    'array' => 'विशेषता: अधिकतम आइटम से अधिक नहीं हो सकता है।',
  ...
  array (
    ...
    'file' => 'गुण: कम से कम होना चाहिए: न्यूनतम किलोबाइट।',
    'numeric' => 'ए: विशेषता कम से कम: मिनट होनी चाहिए।',
  ...
  'required_with' => ': गुण फ़ील्ड आवश्यक है जब: मान मौजूद है।',
  'required_with_all' => ': मान मौजूद होने पर विशेषता फ़ील्ड आवश्यक है।',
  'required_without' => ': गुण फ़ील्ड आवश्यक है जब: मान मौजूद नहीं है।',
  'required_without_all' => ': मान के मौजूद होने पर विशेषता फ़ील्ड की आवश्यकता होती है।',
  ...
  'starts_with' => ': गुण होना चाहिए: आकार वर्ण।',
