...
<div class="home-hero__wrap home--height" style="background-image: url({{IMAGE_PATH_SETTINGS.$background_image}}); height: 20em;">
         ...
         <div class="col-lg-8 col-xs-12">
            ...
            <div class="col-lg-4 col-xs-12">
             ...
             @endphp  
                ...
                <img src="{{$default_im_path}}"  class="hiw-content-image"  alt="icon">
   ...
   <div class="home-section home-section__white" style="background-image: url({{ PUBLIC_ASSETS }}images/exp-bg.jpg);background-repeat: no-repeat;">
      <div class="container expertise-margin">
         <div class="row">
            <div class="col-md-12">
               <h2 class="home-section__title">{{$content_one_main_heading}}</h2>
            </div>
         </div>
        <br/>
         ...
         <div class="row card-margin">
            <div class="col-md-6 col-xs-12">
               <div class="home-section__work-wrap sty-h420">
                  ...
                  <h3>{{$content_one_card_one_heading}}</h3>
                  <p>{{$content_one_card_one_heading_caption}}
                  </p>
               </div>
            </div>
            <div class="col-md-6 col-xs-12">
               <div class="home-section__work-wrap sty-h420">
                  ...
                  <h3>{{$content_one_card_two_heading}}</h3>
                  <p>{{$content_one_card_two_heading_caption}}
                  </p>
               </div>
            </div>
   ...
   <div class="home-section home-section__white">
      <div class="container">
         <div class="row">
            <div class="col-md-12">
               <h2 class="home-section__title">{{$contact_heading}}</h2>
            </div>
         </div>
         <div class="row">
         <div class="col-lg-4 col-xs-12">
          ...
          @endphp
            ...
            <img src="{{$contact_im_path}}"  class="hiw-content-image"  alt="icon">
           
            </div>
         <div class="col-lg-8 col-xs-12">
            <p class="about-us-h3">{{$contact}} 
            </p>
