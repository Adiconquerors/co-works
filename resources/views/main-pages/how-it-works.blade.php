...
<main class="main">
   ...
   <!-- Our Expertise2 -->
   <div class="home-section home-section__white" style="background-image: url({{ PUBLIC_ASSETS }}images/howitworks-bg-fade.jpg);background-repeat: no-repeat;">
      <div class="container">
                        ...
                        <div class="underline-item ">
                           <ul class="nav--tab" id="nav--tab">
                              <li id="tab-01" class="active">
                                 <span class="sty-fs17em"><strong>@lang('main.home.seeker')</strong></span>
                              </li>
                              <li id="tab-02">
                                 <span class="sty-fs17em"><strong>@lang('main.home.owner')</strong></span>
                              </li>
                        ...
                        <div class="row">
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/discover.png" alt="icon">
                                 <h3>{{$seeker_card_one_heading}}</h3>
                                 <p>{{$seeker_card_one_heading_caption}}</p>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/compare.png" alt="icon">
                                 <h3>{{$seeker_card_two_heading}}</h3>
                                 <p>{{$seeker_card_two_heading_caption}}</p>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/schedule.png" alt="icon">
                                 <h3>{{$seeker_card_three_heading}}</h3>
                                 <p>{{$seeker_card_three_heading_caption}}</p>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/pick.png" alt="icon">
                                 <h3>{{$seeker_card_four_heading}}</h3>
                                 <p>{{$seeker_card_four_heading_caption}}</p>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="tabbed-content tab-02">
                     <div class="subcontent">
                        <div class="row">
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/list.png" alt="icon">
                                 <h3>{{$owner_card_one_heading}} </h3>
                                 <p>{{$owner_card_one_heading_caption}}
                                 </p>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/manage.png" alt="icon">
                                 <h3>{{$owner_card_two_heading}}</h3>
                                 <p>{{$owner_card_two_heading_caption}}
                                 </p>
                              </div>
                           </div>
                           <div class="col-md-6">
                              <div class="home-section__work-wrap sty-h270">
                                 <img src="{{ PUBLIC_ASSETS }}images/icons/deal.png" alt="icon">
                                 <h3>{{$owner_card_three_heading}}</h3>
                                 <p>{{$owner_card_three_heading_caption}}</p>
                              </div>
                           </div>
                        </div>
                     </div>
