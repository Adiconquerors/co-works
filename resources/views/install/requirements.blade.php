...
<div class="login-content installation-page" >
		...
		<div class="logo text-center"><img src="{{url(PREFIX1 . 'assets/images/coworking-logs/Asset-1.png')}}" alt="" height="100" width="300"></div>
...
<a href="{{route('install.index')}}" title="Instructions" class="btn button btn-info btn-lg"><span class="styy_nne">Instructions</span></a>&nbsp;&nbsp;
