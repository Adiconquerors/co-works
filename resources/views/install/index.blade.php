...
<div class="login-content installation-page styy_inp">
		...
		<div class="logo text-center"><img src="{{url(PREFIX1 . 'assets/images/coworking-logs/Asset-1.png')}}" alt="Coworking Space" height="100" width="300"></div>
...
<a class="btn button btn-success btn-lg" href="{{url('install-check-requiremetns')}}"><span class="styy_spaa">Let’s go!</span></a>
