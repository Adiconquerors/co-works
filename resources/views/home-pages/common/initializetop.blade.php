<?php
 ...
 ?>
 <script src="//maps.googleapis.com/maps/api/js?key={{$google_api_key}}&libraries=geometry,places">
        </script>
...
{
    window.location = '{{PREFIX}}properties?location=' + property_address_city + '&wstype=all';
}
