...
<script type="text/javascript">
    jQuery(document).ready(function($) {
      ...
      $(document).on('submit', '#frmLogin', function(e) {
            ...
            $('.error').remove();
            if ( email == '' ) {
              $('#login-email').after('<span class="error">{{ trans("custom.eforms.enter-email") }}</span>');
              error++;
            }  else if( !re.test(email) ) {
              $( '#email' ).after( '<span class="error">{{ trans("custom.eforms.enter-valid-email") }}</span>' );
              error++;
            }
        ...
        $(document).on('submit', '#frmRegister', function(e) {
            ...
            if( currency_id == '' ) {
               $('#currency_id').after('<span class="error">{{ trans("custom.eforms.enter-currency") }}</span>');
                error++;
            }
            ...
            if ( email == '' ) {
              ...
              $( '#sign-up-email' ).after( '<span class="error">{{ trans("custom.eforms.enter-valid-email") }}</span>' );
              error++;
            }
