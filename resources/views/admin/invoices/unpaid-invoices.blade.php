            ...
            <div class="col-sm-6 col-md-6">
               <div class="form-group">
                  <label class="control-label sty-mtfs">
                    @lang('custom.paymenthistory.unpaid-invoices')
                  </label>
               </div>
            </div>
...
<div class="row">
  <div class="col-sm-12">
   @include('admin.common.payment-filters',array('route'=>['unpaid.invoices']),compact($items))
  </div>
</div>
@endif
...
<div class="card">
   <div class="card-body">
      @include('admin.invoices.unpaid-list',compact( $items ))
   </div>
</div>

@include('admin.invoices.modal-loading')
...
@include('admin.invoices.scripts.formscripts')
