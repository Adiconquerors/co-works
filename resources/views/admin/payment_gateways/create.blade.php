        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <div class="form-line">
                    {!! Form::text('name', old('name'), ['class' => 'form-control', 'placeholder' => trans('global.payment-gateways.fields.name'), 'required' => '']) !!}
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('description', old('description'), ['class' => 'form-control', 'placeholder' => trans('global.payment-gateways.fields.description')]) !!}
                    <p class="help-block"></p>
