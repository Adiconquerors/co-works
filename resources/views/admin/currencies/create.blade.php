...
<div class="row">
  ...
  @endif
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['currencies.store'],'class'=>'formvalidation']) !!}
      ...
      <div class="text-center">
         <button type="submit" class="btn btn-success waves-effect waves-light">{{ trans('global.app_create') }}</button>
      </div>
