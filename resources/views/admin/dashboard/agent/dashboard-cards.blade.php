<div class="col-xl-3 col-md-6">
     ...
     <div class="col-xl-3 col-md-6">
        <div class="card-box tilebox-two tilebox-pink">
            ...
            <h6 class="text-pink text-uppercase m-b-15 m-t-10">  @lang('custom.dashboard.booking-initiated')</h6>
            </a>
            <h2 class="m-b-10" data-plugin="counterup">{{ $booking_initiated }}  </h2>
        </div>
    </div>
     ...
     <div class="col-xl-3 col-md-6">
       <div class="card-box tilebox-two tilebox-success">
            <i class="mdi mdi-currency-usd float-right text-dark"></i>
            <h6 class="text-success text-uppercase m-b-15 m-t-10"> @lang('custom.dashboard.deals-completed')</h6>

            <h2 class="m-b-10"><span data-plugin="counterup">{{$deals_completed}}</span></h2>
        </div>
 </div>