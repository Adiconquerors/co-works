   ...
   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
      ...
      <div class="db-pageheader d-flex justify-content-between">
         ...
         <div class="d-flex align-items-center">
            <a href="{{ route('templates.index') }}" class="btn btn-primary">@lang('custom.eforms.back-to-tempalte')</a>
         </div>
      </div>
      <!-- pageheader close  -->
   </div>
   ...
   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
      <div class="db-card listing-details">
         <div class="db-card-header">
            <h3 class="db-card-header-title"> @lang('custom.eforms.template-details')</h3>
         </div>
         <div class="db-card-body">
            <!-- listing form start -->
 
   {!! Form::model($template, ['method' => 'PUT', 'route' => ['templates.update', $template->id],'class'=>'formvalidation']) !!}
