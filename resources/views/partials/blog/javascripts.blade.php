...
<script src="{{ PUBLIC_ASSETS }}js-maps/blog.js" type="text/javascript"></script>
	...
	$( function() {
	    ...
	    $( ".top-blog-search" ).autocomplete({
	      ...
	      select: function( event, ui ) {
	        ...
	        console.log(ui);
	        window.location = '{{url("blog-article")}}/' + ui.item.value;
	      }
	    });
	  } );
</script>
...
<!-- Subscribe to news letter -->
  <script  type="text/javascript">
    ...
    $(document).on('submit', '#suscribe_to_news_letter', function(e) {
      ...
      $.ajax({
        url: "{{route('blog.subscribenewsletter')}}",
        type: 'POST',
        data: {
          _token: _token,
          email: email,
