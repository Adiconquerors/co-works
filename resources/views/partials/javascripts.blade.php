...
<script>
  window.utilsUrl = "{{PUBLIC_ASSETS}}js/utils.homepage.js";
</script>

<script src="{{PUBLIC_ASSETS}}js/modernizr/2.8.3/modernizr.min.js"></script>
<script src="{{PUBLIC_ASSETS}}js/app.homepage.js"></script>

<script src="{{PUBLIC_ASSETS}}js/font-awesome/use-fontawesome.js"></script>
<script src="{{PUBLIC_ASSETS}}js/Login-modal-script.js"></script>
...
@include('home-pages.scripts.common-login-modal-scripts')
  ...
  <!-- Scripts -->
    <!-- sidebar -->
    <script src="{{PUBLIC_ASSETS}}js/classie.js"></script>
    <script src="{{PUBLIC_ASSETS}}js/gnmenu.js"></script>
        <script>
