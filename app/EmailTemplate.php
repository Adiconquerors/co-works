...
class EmailTemplate extends Model
{
    ...
    public static $searchable = ['title','key','type','subject'];
    ...
    {
        return EmailTemplate::where('key','=',$slug)->first();
    }
   ...
   /**
    ...
    {   
        ...
        \Mail::send('admin.templates.mail.template', ['body' => $result], function ($message) use ($template, $data) 
        {
    ...
    public function getTemplate($template, $data)
    {
        ...
        $view = \View::make('admin.templates.mail.template', [
