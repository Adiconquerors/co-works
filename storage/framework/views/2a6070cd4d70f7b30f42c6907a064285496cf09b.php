...
<div class="row">
  ...
  <?php endif; ?>
   ...
   <?php $button_name = trans('global.app_create'); ?>
      ...
      <?php echo Form::model($article, ['method' => 'PUT', 'route' => ['articles.update',$article->id], 'files' => true,'name'=>'formArticleType','class'=>'formvalidation', 'enctype' => 'multipart/form-data' ]); ?>

            
      <?php else: ?>


      <?php echo Form::open(['method' => 'POST', 'route' => ['articles.store'], 'files' => true,'name'=>'formArticleType','class'=>'formvalidation', 'enctype' => 'multipart/form-data']); ?>


        <?php endif; ?>

        <?php echo $__env->make('admin.articles.form-elements', 
                array('button_name'=> $button_name,'article'=>$article ), \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
