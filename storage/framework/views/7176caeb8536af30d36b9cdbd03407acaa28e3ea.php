      ...
      <div class="page-title-box">
         ...
         <ol class="breadcrumb p-0 m-0">
            <li class="breadcrumb-item">
               <a href="<?php echo e(route('membership_fees.index')); ?>"><?php echo e(ucwords($active_class)); ?></a>
            </li>
...
<div class="row">
  ...
  <?php endif; ?>
   ...
   <?php $button_name = trans('global.app_create'); ?>
      ...
      <?php echo Form::model($record, ['method' => 'PUT', 'route' => ['membership_fees.update',$record->id,'class'=>'formvalidation'], 'files' => true,'name'=>'formMemberType' ]); ?>

            
      <?php else: ?>

      <?php echo Form::open(['method' => 'POST', 'route' => ['membership_fees.store'], 'files' => true,'name'=>'formMemberType','class'=>'formvalidation']); ?>



        <?php endif; ?>

        <?php echo $__env->make('admin.membershipfees.form-elements', 
