        ...
        <div class="col-sm-6 col-md-6">
          <div class="form-group">
            <label class="control-label sty-mtfs">
              <?php echo app('translator')->getFromJson('custom.clients.clients'); ?>
            </label>
          </div>
        </div>
      </div>
...
<div class="card">
  <div class="card-body">
    <?php echo $__env->make('admin.enquires.clients.client-list',compact( $items ), \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>
</div>
