      ...
      <div class="page-title-box">
         ...
         <ol class="breadcrumb p-0 m-0">
            <li class="breadcrumb-item">
               <a href="<?php echo e(route('our_clients.index')); ?>"><?php echo e(ucwords($active_class)); ?></a>
            </li>
...
<div class="row">
  ...
  <?php endif; ?>
   ...
   <?php $button_name = trans('global.app_create'); ?>
      ...
      <?php echo Form::model($record, ['method' => 'PUT', 'route' => ['our_clients.update',$record->id], 'files' => true,'name'=>'formOurClientType','class'=>'formvalidation', 'enctype' => 'multipart/form-data' ]); ?>

            
      <?php else: ?>


      <?php echo Form::open(['method' => 'POST', 'route' => ['our_clients.store'], 'files' => true,'name'=>'formOurClientType','class'=>'formvalidation', 'enctype' => 'multipart/form-data']); ?>


        <?php endif; ?>

        <?php echo $__env->make('admin.ourclients.form-elements', 
