...
<div class="row">
  ...
  <?php endif; ?>
   ...
   <?php $button_name = trans('global.app_create'); ?>
      ...
      <?php echo Form::model($record, ['method' => 'PUT', 'route' => ['menus.update',$record->id], 'files' => true,'name'=>'formMenuType','class'=>'formvalidation', 'enctype' => 'multipart/form-data' ]); ?>


      <?php else: ?>


      <?php echo Form::open(['method' => 'POST', 'route' => ['menus.store'], 'files' => true,'name'=>'formMenuType','class'=>'formvalidation', 'enctype' => 'multipart/form-data']); ?>


        <?php endif; ?>

        <?php echo $__env->make('admin.menus.form-elements',
