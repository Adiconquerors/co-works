<div class="col-xl-3 col-md-6">
       ...
       <div class="col-xl-3 col-md-6">
        <div class="card-box tilebox-two tilebox-pink">
            ...
            <h6 class="text-pink text-uppercase m-b-15 m-t-10"> <?php echo app('translator')->getFromJson('custom.dashboard.unpaid-invoices'); ?></h6>
            </a>
            <h2 class="m-b-10" data-plugin="counterup"><?php echo e($unpaid_invoices); ?>  </h2>
        </div>
    </div>
    ...
    <div class="col-xl-3 col-md-6">
       <div class="card-box tilebox-two tilebox-success">
            <i class="mdi mdi-currency-usd float-right text-dark"></i>
            <h6 class="text-success text-uppercase m-b-15 m-t-10"><?php echo app('translator')->getFromJson('custom.dashboard.paid-invoices'); ?></h6>

            <h2 class="m-b-10"><span data-plugin="counterup"><?php echo e($paid_invoices); ?></span></h2>
        </div>
    </div>