         ...
         <div class="w3-row w3-card-4 w3-grey w3-round-large w3-border comparePanle w3-margin-top ">
            <div class="w3-row ">
               <div class="w3-col l9 m8 s6 ">
                  <h4><b><?php echo app('translator')->getFromJson('custom.compare.products'); ?></b></h4>
               </div>
               <div class="w3-col l3 m4 s6 w3-margin-top ">

                  <button class="w3-btn w3-round-small w3-white w3-border notActive cmprBtn " disabled title="Compare Properties "><b><?php echo app('translator')->getFromJson('custom.compare.compare'); ?></b></button>
      ...
      <div id="WarningModal " class="w3-modal ">
         <div class="w3-modal-content warningModal ">
            <header class="w3-container w3-teal ">
               <h3 class="sty-f20"><span>⚠</span> &nbsp;<?php echo app('translator')->getFromJson('custom.compare.error'); ?></h3>
            </header>
            <div class="w3-container ">
               <h4><?php echo app('translator')->getFromJson('custom.compare.max-three'); ?></h4>
            </div>
            <footer class="w3-container w3-right-align ">
               <button id="warningModalClose " onclick="document.getElementById( 'id01').style.display='none' " class="w3-btn w3-hexagonBlue w3-margin-bottom "><?php echo app('translator')->getFromJson('custom.compare.ok'); ?></button>
            </footer>
         </div>
      </div>
   </div>
