      ...
      <div class="form_container">
        <div class="row clearfix">
          <div class="">
            ...
            <form class="" role="form" id="proforma_form" method="post">
              <div class="row clearfix">
                <div class="col_half">
                ...
                <div class="col_half">
                  ...
                  <div class="input_field"> 
                    ...
                    <input type="email" name="toemail" id="toemail" value="" placeholder="<?php echo app('translator')->getFromJson('custom.eforms.toemail'); ?>" />
                  </div>
                </div>
                <div class="col_half">
                ...
                <div class="col_half">
                  ...
                  <div class="input_field">
                   <span><i aria-hidden="true" class="fas fa-chair"></i></span>
                ...
                <div class="col_half">
                  ...
                  <div class="input_field">
                   <span><i aria-hidden="true" class="fa fa-inr"></i></span>
