...
<head>
    ...
    <title><?php echo app('translator')->getFromJson('custom.translationmanager.translationmanager'); ?></title>
    <link rel="stylesheet" href="<?php echo e(PUBLIC_ASSETS_NEW_ADMIN); ?>css/bootstrap.min.css">
    ...
    <link href="<?php echo e(PUBLIC_ASSETS_NEW_ADMIN); ?>translations/bootstrap-editable.css" rel="stylesheet"/>
    <script src="<?php echo e(PUBLIC_ASSETS_NEW_ADMIN); ?>translations/bootstrap-editable.min.js"></script>
...
.btn {
    ...
    <p class="ML-top"><?php echo app('translator')->getFromJson('custom.translationmanager.translationwarning'); ?><code><?php echo app('translator')->getFromJson('custom.translationmanager.translationexport'); ?></code> <?php echo app('translator')->getFromJson('custom.translationmanager.commandpublish'); ?></p>
    <div class="alert alert-success success-import" id="styy_dnnn1">
        <p><?php echo app('translator')->getFromJson('custom.translationmanager.processed'); ?> <strong class="counter"><?php echo app('translator')->getFromJson('custom.translationmanager.n'); ?></strong> <?php echo app('translator')->getFromJson('custom.translationmanager.groups'); ?></p>
    </div>
    <div class="alert alert-success success-find" id="styy_dnnn2">
        <p><?php echo app('translator')->getFromJson('custom.translationmanager.found'); ?> <strong class="counter"><?php echo app('translator')->getFromJson('custom.translationmanager.n'); ?></strong> <?php echo app('translator')->getFromJson('custom.translationmanager.items'); ?></p>
    </div>
    <div class="alert alert-success success-publish" id="styy_dnnn3">
        <p><?php echo app('translator')->getFromJson('custom.translationmanager.for-group'); ?> '<?php echo $group ?>'!</p>
    </div>
    <div class="alert alert-success success-publish-all" id="styy_dnnn1">
        <p><?php echo app('translator')->getFromJson('custom.translationmanager.for-all-group'); ?></p>
    </div>
    ...
    <p>
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <select name="replace" class="form-control">
                            <option value="0"><?php echo app('translator')->getFromJson('custom.translationmanager.new-translations'); ?></option>
                            <option value="1"><?php echo app('translator')->getFromJson('custom.translationmanager.replace-translations'); ?></option>
                        </select>
                    </div>
                    <div class="col-sm-2">
                    <button type="submit" class="btn btn-success btn-block"  data-disable-with="Loading.."><?php echo app('translator')->getFromJson('custom.translationmanager.import-grops'); ?></button>
                    </div>
                </div>
            </div>
        </form>
        <form class="form-find" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postFind') ?>" data-remote="true" role="form" data-confirm="Are you sure you want to scan you app folder? All found translation keys will be added to the database.">
            <div class="form-group">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <button type="submit" class="btn btn-info" data-disable-with="Searching.." ><?php echo app('translator')->getFromJson('custom.translationmanager.in-files'); ?></button>
            </div>
        </form>
        <?php endif; ?>
        <?php if(isset($group)) : ?>
            <form class="form-inline form-publish" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postPublish', $group) ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish the translations group '<?php echo $group ?>? This will overwrite existing language files.">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <button type="submit" class="btn btn-info" data-disable-with="Publishing.." ><?php echo app('translator')->getFromJson('custom.translationmanager.publish-translations'); ?></button>
                <a href="<?php echo action('\Barryvdh\TranslationManager\Controller@getIndex') ?>" class="btn btn-default"><?php echo app('translator')->getFromJson('custom.translationmanager.back'); ?></a>
            </form>
        <?php endif; ?>
    </p>
    <form role="form" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddGroup') ?>">
        <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
        <div class="form-group">
            <p><?php echo app('translator')->getFromJson('custom.translationmanager.choose-para'); ?></p>
        ...
        <div class="form-group">
            <label><?php echo app('translator')->getFromJson('custom.translationmanager.new-key'); ?></label>
    ...
    <?php else: ?>
        <fieldset>
            <legend><?php echo app('translator')->getFromJson('custom.translationmanager.supported-locales'); ?></legend>
            <p>
                <?php echo app('translator')->getFromJson('custom.translationmanager.current-supported-locales'); ?>
            </p>
            ...
            <form class="form-add-locale" method="POST" role="form" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postAddLocale') ?>">
                ...
                <div class="form-group">
                    <p>
                        <?php echo app('translator')->getFromJson('custom.translationmanager.enter-new-key'); ?>
                    </p>
                    <div class="row">
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-2">
                            <button type="submit" class="btn btn-default btn-block"  data-disable-with="Adding.."><?php echo app('translator')->getFromJson('custom.translationmanager.add-new-locale'); ?></button>
                        </div>
                    </div>
                </div>
            </form>
        ...
        <fieldset>
            <legend><?php echo app('translator')->getFromJson('custom.translationmanager.export-translations'); ?></legend>
            <form class="form-inline form-publish-all" method="POST" action="<?php echo action('\Barryvdh\TranslationManager\Controller@postPublish', '*') ?>" data-remote="true" role="form" data-confirm="Are you sure you want to publish all translations group? This will overwrite existing language files.">
                <input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
                <button type="submit" class="btn btn-primary" data-disable-with="Publishing.." ><?php echo app('translator')->getFromJson('custom.translationmanager.publish-all'); ?></button>
            </form>
        </fieldset>
