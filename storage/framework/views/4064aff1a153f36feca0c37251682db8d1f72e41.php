      ...
      <div class="page-title-box">
         ...
         <ol class="breadcrumb p-0 m-0">
            <li class="breadcrumb-item">
               <a href="<?php echo e(route('icon.index')); ?>"><?php echo e(ucwords($active_class)); ?></a>
            </li>
...
<div class="row">
  ...
  <?php endif; ?>
      ...
      <?php echo Form::model($record, ['method' => 'PUT', 'route' => ['icon.update',$record->slug], 'files' => true,'name'=>'formIconType','class'=>'formvalidation' ]); ?>

            
      <?php else: ?>

      <?php echo Form::open(['method' => 'POST', 'route' => ['icon.store'], 'files' => true,'name'=>'formIconType','class'=>'formvalidation']); ?>


        <?php endif; ?>

        <?php echo $__env->make('admin.icons.form-elements', 
