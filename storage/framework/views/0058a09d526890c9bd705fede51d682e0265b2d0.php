...
<div class="row">
  ...
  <?php endif; ?>
   ...
   <?php $button_name = trans('global.app_create'); ?>
      ...
      <?php echo Form::model($record, ['method' => 'PUT', 'route' => ['amenities.update',$record->slug],'name'=>'formAmenityType','class'=>'formvalidation' ]); ?>

            
      <?php else: ?>


      <?php echo Form::open(['method' => 'POST', 'route' => ['amenities.store'], 'files' => true,'name'=>'formAmenityType','class'=>'formvalidation' ]); ?>


        <?php endif; ?>

        <?php echo $__env->make('admin.amenities.form-elements', 
