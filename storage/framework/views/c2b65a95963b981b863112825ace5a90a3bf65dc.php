         ...
         <div class="sty-df">
            <div class="col-sm-6 col-md-6">
               <div class="form-group">
                  ...
                  <?php echo app('translator')->getFromJson('custom.paymenthistory.paid-invoices'); ?>
                  </label>
               </div>
            </div>
...
<div class="row">
  <div class="col-sm-12">
     <?php echo $__env->make('admin.common.payment-filters',array('route'=>['paid.invoices']),compact($items), \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  </div>
</div>
<?php endif; ?>
...
<div class="card">
   <div class="card-body">
      <?php echo $__env->make('admin.invoices.payment-history.payment-history-list',compact( $items ), \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
   </div>
</div>
<!-- end row -->
<?php $__env->stopSection(); ?>
