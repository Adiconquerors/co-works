      ...
      <div class="page-title-box">
         ...
         <ol class="breadcrumb p-0 m-0">
            <li class="breadcrumb-item">
               <a href="<?php echo e(route('templates.index')); ?>"><?php echo e(ucwords($active_class)); ?></a>
            </li>
...
<div class="row">
  ...
  <?php endif; ?>
   ...
   <?php $button_name = trans('global.app_create'); ?>
      ...
      <?php echo Form::model($template, ['method' => 'PUT', 'route' => ['templates.update',$template->id], 'name'=>'formTemplateType','class'=>'formvalidation' ]); ?>

            
      <?php else: ?>


      <?php echo Form::open(['method' => 'POST', 'route' => ['templates.store'], 'name'=>'formTemplateType','class'=>'formvalidation']); ?>


        <?php endif; ?>

        <?php echo $__env->make('admin.templates.form-elements', 
                array('button_name'=> $button_name,'template'=>$template ), \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
